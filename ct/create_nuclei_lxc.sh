...
CTID=$(whiptail --backtitle "Proxmox Nuclei Scanner" --inputbox "Set Container ID (CTID):" 8 58 "$DEFAULT_CTID" --title "CONTAINER ID" 3>&1 1>&2 2>&3)
HOSTNAME=$(whiptail --backtitle "Proxmox Nuclei Scanner" --inputbox "Set Hostname:" 8 58 "${NUCLEI_HOSTNAME:-nuclei-vulnerability-scanner}" --title "HOSTNAME" 3>&1 1>&2 2>&3)
